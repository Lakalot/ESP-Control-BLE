import * as pb from '../generated/manifest_v5.pbjs';
import type {
...
export function decodeManifest(bytes: Uint8Array): RuntimeManifest {
  let msg: pb.esp_control.v5.ManifestBundleV5;
  try {
    msg = V.ManifestBundleV5.decode(bytes);
  } catch (err) {
  ...
  const parseRule = (r: pb.esp_control.v5.IRule | null | undefined): RuntimeRule | undefined => {
