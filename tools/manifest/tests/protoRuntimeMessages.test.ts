...
import * as pb from '../src/generated/manifest.pbjs.js';

const proto = readFileSync(join(__dirname, '../../../proto/manifest.proto'), 'utf8');
const root = pb.esp_control;

describe('manifest.proto runtime messages', () => {
